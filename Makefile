...
DOCKER_DIR_GENERATE := $(if $(BIND_DIR),-v "/root/lstm/$(BIND_DIR)")
DOCKER_MOUNT := $(if $(BIND_DIR),-v "$(CURDIR)/$(BIND_DIR):/root/lstm/$(BIND_DIR)")

DOCKER_MOUNT := $(if $(DOCKER_MOUNT),$(DOCKER_MOUNT),-v "/root/lstm/$(BIND_DIR)")
